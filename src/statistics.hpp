...
public:
  enum class PacketType {
    ...
    SENT_INTERNAME_LSA_INTEREST,
    SENT_EXTERNALNAME_LSA_INTEREST,
    SENT_LSA_DATA,
    SENT_ADJ_LSA_DATA,
    SENT_COORD_LSA_DATA,
    SENT_NAME_LSA_DATA,
    SENT_INTERNAME_LSA_DATA,
    SENT_EXTERNALNAME_LSA_DATA,
    RCV_LSA_INTEREST,
    RCV_ADJ_LSA_INTEREST,
    RCV_COORD_LSA_INTEREST,
    RCV_NAME_LSA_INTEREST,
    RCV_INTERNAME_LSA_INTEREST,
    RCV_EXTERNALNAME_LSA_INTEREST,
    RCV_LSA_DATA,
    RCV_ADJ_LSA_DATA,
    RCV_COORD_LSA_DATA,
    RCV_NAME_LSA_DATA
