...
const ndn::PartialName INTERNAMES_DATASET = ndn::PartialName("lsdb/internames");
const ndn::PartialName EXTERNALNAMES_DATASET = ndn::PartialName("lsdb/externalnames");
const ndn::PartialName NET_EXTERNALNAMES_DATASET = ndn::PartialName("lsdb/netExternalnames");
...
const Lsdb& lsdb, const RoutingTable& rt)
...
DatasetInterestHandler::setDispatcher(ndn::mgmt::Dispatcher& dispatcher)
{
  ...
  dispatcher.addStatusDataset(INTERNAMES_DATASET,
    ndn::mgmt::makeAcceptAllAuthorization(),
    std::bind(&DatasetInterestHandler::publishLsaStatus<InterNameLsa>, this, _1, _2, _3));

  dispatcher.addStatusDataset(EXTERNALNAMES_DATASET,
    ndn::mgmt::makeAcceptAllAuthorization(),
    std::bind(&DatasetInterestHandler::publishLsaStatus<ExternalNameLsa>, this, _1, _2, _3));

  dispatcher.addStatusDataset(NET_EXTERNALNAMES_DATASET,
    ndn::mgmt::makeAcceptAllAuthorization(),
    std::bind(&DatasetInterestHandler::publishLsaStatus<NetExternalNameLsa>, this, _1, _2, _3));
