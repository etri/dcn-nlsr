...
public:
  SyncProtocolAdapter(ndn::Face& facePtr,
                      ...
                      const SyncUpdateCallback& syncUpdateCallback, const ConfParameter & );
   ...
   */
  void
  addUserNode(uint64_t, const ndn::Name& userPrefix);
   ...
   */
  void
  publishUpdate(uint64_t, const ndn::Name& userPrefix, uint64_t seq);
...
private:
  ...
  std::map<uint64_t, std::shared_ptr<psync::FullProducer>> m_psyncLogic2;
