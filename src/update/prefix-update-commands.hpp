...
class AggregatePrefixCommand : public ndn::nfd::ControlCommand
{
public:
  AggregatePrefixCommand();
};

class RedistributePrefixCommand : public ndn::nfd::ControlCommand
{
public:
  RedistributePrefixCommand();
};
} // namespace update
} // namespace nlsr
