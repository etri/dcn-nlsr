...
void
SegmentPublisher::publish(const ndn::Interest &interest, const ndn::Name& interestName, const ndn::Name& dataName,
                          ...
                          const ndn::security::SigningInfo& signingInfo)
{
  ...
  publish(interest, interestName, dataName, buf, freshness, signingInfo);
}
